...
1. Go to the [**Security** tab](https://github.com/dhh1128/cite2link/security) of this repository.
...
- The type of issue (e.g. injection, data exposure, dependency vuln).
...
cite2link is a personal open-source project. **We do not offer a paid bug
bounty or any other monetary reward** for vulnerability reports. We genuinely
...
cite2link is pre-1.0 and ships from the `main` branch. Security fixes are
applied to `main`; there are no long-term support branches. Please ensure you
are running the latest version before reporting.
